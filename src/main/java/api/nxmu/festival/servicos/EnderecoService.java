            ...
            for (ImportacaoDto importacao : importacoes) {
                ...
                long idPart = participanteService.salvar(
                        new ParticipanteDto(
                                ...
                                importacao.getNomeResponsavel(),
                                importacao.getGenero(),
                                importacao.getNascimento(),
                                importacao.getDocumentorg(),
                                importacao.getEmail(),
                                importacao.getNecessidade(),
                                importacao.getDescrinescessidade(),
                                idApre, new byte[0])
                );
                ...
                Endereco e = new Endereco(
                        ...
                        importacao.getTelefone(), participanteService.encontrarPorId(idPart).get());
